...
#define EMUVERSION "V0.3.2 2022-08-23"
...
void uiAbout() {
	...
	drawText(" DPad:   Move ship", 6, 0);
	drawText(" B:      Shoot", 7, 0);
	drawText(" A:      Special attack", 8, 0);

	drawText(" FinalizerDS " EMUVERSION, 20, 0);
...
void uiLoadGame() {
	...
	drawMenuItem(" Finalizer - Super Transformation (set 1)");
	drawMenuItem(" Finalizer - Super Transformation (set 2)");
	drawMenuItem(" Finalizer - Super Transformation (bootleg)");
}
