...
int loadSettings() {
	...
	g_dipSwitch0 = cfg.dipSwitchFN0;
	g_dipSwitch1 = cfg.dipSwitchFN1;
	g_dipSwitch2 = cfg.dipSwitchFN2;
	g_dipSwitch3 = cfg.dipSwitchFN3;
...
void saveSettings() {
	...
	cfg.dipSwitchFN0 = g_dipSwitch0;
	cfg.dipSwitchFN1 = g_dipSwitch1;
	cfg.dipSwitchFN2 = g_dipSwitch2;
	cfg.dipSwitchFN3 = g_dipSwitch3;
...
void loadState(void) {
	...
	strlcpy(stateName, games[selectedGame].gameName, sizeof(stateName)-4);
