...
int loadSettings() {
	...
	gDipSwitch0  = cfg.dipSwitchFN0;
	gDipSwitch1  = cfg.dipSwitchFN1;
	gDipSwitch2  = cfg.dipSwitchFN2;
	gDipSwitch3  = cfg.dipSwitchFN3;
...
void saveSettings() {
	...
	cfg.dipSwitchFN0 = gDipSwitch0;
	cfg.dipSwitchFN1 = gDipSwitch1;
	cfg.dipSwitchFN2 = gDipSwitch2;
	cfg.dipSwitchFN3 = gDipSwitch3;
